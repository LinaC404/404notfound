...
! function(t, e) {
    ...
    var o = i((function(t, e) {
        t.exports = function() {
            ...
            function k(t, e) {
                var i, n, o;
                if (u(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), u(e._i) || (t._i = e._i), u(e._f) || (t._f = e._f), u(e._l) || (t._l = e._l), u(e._strict) || (t._strict = e._strict), u(e._tzm) || (t._tzm = e._tzm), u(e._isUTC) || (t._isUTC = e._isUTC), u(e._offset) || (t._offset = e._offset), u(e._pf) || (t._pf = g(e)), u(e._locale) || (t._locale = e._locale), _.length > 0)
            ...
            function Ln(t, e, i, n) {
                var r = e._milliseconds,
                    s = ln(e._days),
                    a = ln(e._months);
                t.isValid() && (n = null == n || n, a && ue(t, pt(t, "Month") + a * i), s && ft(t, "Date", pt(t, "Date") + s * i), r && t._d.setTime(t._d.valueOf() + r * i), n && o.updateOffset(t, s || a))
            }
    ...
    function jn(t, e) {
        return function(t) {
            ...
            var i = t && (void 0 !== Cn && ai(t) || t["@@iterator"]);
            if (null != i) {
                var n, o, r = [],
                    s = !0,
                    a = !1;
    ...
    var Ud = function(t) {
        ...
        Zd = zd(zd({}, Il), {}, {
            ...
            setupXSSProtection: function(t) {
                t && (!0 === t.disabled ? (qd = Xd, console.warn("You disabled XSS protection for vis-Timeline. I sure hope you know what you're doing!")) : t.filterOptions && (qd = Ud(t.filterOptions)))
            }
        });
    hn(Zd, "xss", {
        get: function() {
            ...
            return pn(i, [{
                ...
                value: function(t) {
                    if (this.options.selectable && this.options.editable.add) {
                        ...
                        "drop" == t.type ? ((i = JSON.parse(t.dataTransfer.getData("text"))).content = i.content ? i.content : "new item", i.start = i.start ? i.start : o ? o(a, l, h) : a, i.type = i.type || "box", i[this.itemsData.idProp] = i.id || Su(), "range" != i.type || i.end || (e = this.body.util.toTime(s + this.props.width / 5), i.end = o ? o(e, l, h) : e)) : ((i = {
                            start: o ? o(a, l, h) : a,
                            content: "new item"
